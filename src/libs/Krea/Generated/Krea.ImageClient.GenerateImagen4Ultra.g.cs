...
namespace Krea
{
    public partial class ImageClient
    {
        ...
        private static readonly global::Krea.EndPointSecurityRequirement s_GenerateImagen4UltraSecurityRequirement0 =
        ...
        private static readonly global::Krea.EndPointSecurityRequirement[] s_GenerateImagen4UltraSecurityRequirements =
            new global::Krea.EndPointSecurityRequirement[]
            {                s_GenerateImagen4UltraSecurityRequirement0,
            };
        partial void PrepareGenerateImagen4UltraArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Krea.ImageGenerationRequest request);
        partial void PrepareGenerateImagen4UltraRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Krea.ImageGenerationRequest request);
        partial void ProcessGenerateImagen4UltraResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateImagen4UltraResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Krea.Job> GenerateImagen4UltraAsync(

            global::Krea.ImageGenerationRequest request,
            global::Krea.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenerateImagen4UltraAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Krea.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Krea.AutoSDKHttpResponse<global::Krea.Job>> GenerateImagen4UltraAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateImagen4UltraArguments(
            ...
            var __authorizations = global::Krea.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateImagen4UltraSecurityRequirements,
                operationName: "GenerateImagen4UltraAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateImagen4UltraRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Krea.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Krea.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateImagen4Ultra",
                                methodName: "GenerateImagen4UltraAsync",
                                pathTemplate: "\"/generate/image/google/imagen-4-ultra\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateImagen4UltraResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Krea.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateImagen4UltraResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GenerateImagen4UltraAsync(
                request: __request,
                requestOptions: requestOptions,
