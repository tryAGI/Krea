...
namespace Krea
{
    public partial class ImageClient
    {
        ...
        private static readonly global::Krea.EndPointSecurityRequirement s_GenerateFlux11ProSecurityRequirement0 =
        ...
        private static readonly global::Krea.EndPointSecurityRequirement[] s_GenerateFlux11ProSecurityRequirements =
            new global::Krea.EndPointSecurityRequirement[]
            {                s_GenerateFlux11ProSecurityRequirement0,
            };
        partial void PrepareGenerateFlux11ProArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? xWebhookUrl,
            global::Krea.ImageGenerationRequest request);
        partial void PrepareGenerateFlux11ProRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? xWebhookUrl,
            global::Krea.ImageGenerationRequest request);
        partial void ProcessGenerateFlux11ProResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateFlux11ProResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </summary>
        /// <param name="xWebhookUrl"></param>
        /// <param name="request"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Krea.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Krea.Job> GenerateFlux11ProAsync(

            global::Krea.ImageGenerationRequest request,
            string? xWebhookUrl = default,
            global::Krea.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenerateFlux11ProAsResponseAsync(

                request: request,
                xWebhookUrl: xWebhookUrl,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Krea.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Krea.AutoSDKHttpResponse<global::Krea.Job>> GenerateFlux11ProAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateFlux11ProArguments(
                httpClient: HttpClient,
                xWebhookUrl: ref xWebhookUrl,
                request: request);


            var __authorizations = global::Krea.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GenerateFlux11ProSecurityRequirements,
                operationName: "GenerateFlux11ProAsync");
            ...
            if (xWebhookUrl != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("X-Webhook-URL", xWebhookUrl.ToString());
            }
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateFlux11ProRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Krea.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Krea.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateFlux11Pro",
                                methodName: "GenerateFlux11ProAsync",
                                pathTemplate: "\"/generate/image/bfl/flux-1.1-pro\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateFlux11ProResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Krea.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateFlux11ProResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GenerateFlux11ProAsync(
                xWebhookUrl: xWebhookUrl,
                request: __request,
                requestOptions: requestOptions,
