...
namespace Krea
{
    public partial class VideoClient
    {
        ...
        private static readonly global::Krea.EndPointSecurityRequirement s_GenerateHailuo23FastSecurityRequirement0 =
        ...
        private static readonly global::Krea.EndPointSecurityRequirement[] s_GenerateHailuo23FastSecurityRequirements =
            new global::Krea.EndPointSecurityRequirement[]
            {                s_GenerateHailuo23FastSecurityRequirement0,
            };
        partial void PrepareGenerateHailuo23FastArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Krea.VideoGenerationRequest request);
        partial void PrepareGenerateHailuo23FastRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Krea.VideoGenerationRequest request);
        partial void ProcessGenerateHailuo23FastResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateHailuo23FastResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Generate video with Hailuo 2.3 Fast
        /// </summary>
        /// <param name="request"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Krea.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Krea.Job> GenerateHailuo23FastAsync(

            global::Krea.VideoGenerationRequest request,
            global::Krea.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenerateHailuo23FastAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Krea.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Krea.AutoSDKHttpResponse<global::Krea.Job>> GenerateHailuo23FastAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateHailuo23FastArguments(
            ...
            var __authorizations = global::Krea.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateHailuo23FastSecurityRequirements,
                operationName: "GenerateHailuo23FastAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateHailuo23FastRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Krea.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Krea.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateHailuo23Fast",
                                methodName: "GenerateHailuo23FastAsync",
                                pathTemplate: "\"/generate/video/minimax/hailuo-2.3-fast\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateHailuo23FastResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Krea.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateHailuo23FastResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GenerateHailuo23FastAsync(
                request: __request,
                requestOptions: requestOptions,
