...
namespace Krea
{
    public partial class VideoClient
    {
        ...
        private static readonly global::Krea.EndPointSecurityRequirement s_GenerateRunwayGen3SecurityRequirement0 =
        ...
        private static readonly global::Krea.EndPointSecurityRequirement[] s_GenerateRunwayGen3SecurityRequirements =
            new global::Krea.EndPointSecurityRequirement[]
            {                s_GenerateRunwayGen3SecurityRequirement0,
            };
        partial void PrepareGenerateRunwayGen3Arguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Krea.VideoGenerationRequest request);
        partial void PrepareGenerateRunwayGen3Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Krea.VideoGenerationRequest request);
        partial void ProcessGenerateRunwayGen3Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateRunwayGen3ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Krea.Job> GenerateRunwayGen3Async(

            global::Krea.VideoGenerationRequest request,
            global::Krea.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenerateRunwayGen3AsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Krea.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Krea.AutoSDKHttpResponse<global::Krea.Job>> GenerateRunwayGen3AsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateRunwayGen3Arguments(
            ...
            var __authorizations = global::Krea.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateRunwayGen3SecurityRequirements,
                operationName: "GenerateRunwayGen3Async");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateRunwayGen3Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Krea.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Krea.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateRunwayGen3",
                                methodName: "GenerateRunwayGen3Async",
                                pathTemplate: "\"/generate/video/runway/gen-3\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateRunwayGen3Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Krea.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateRunwayGen3ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GenerateRunwayGen3Async(
                request: __request,
                requestOptions: requestOptions,
