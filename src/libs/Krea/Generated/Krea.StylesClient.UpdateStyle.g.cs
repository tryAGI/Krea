...
namespace Krea
{
    public partial class StylesClient
    {
        ...
        private static readonly global::Krea.EndPointSecurityRequirement s_UpdateStyleSecurityRequirement0 =
        ...
        private static readonly global::Krea.EndPointSecurityRequirement[] s_UpdateStyleSecurityRequirements =
            new global::Krea.EndPointSecurityRequirement[]
            {                s_UpdateStyleSecurityRequirement0,
            };
        partial void PrepareUpdateStyleArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::Krea.UpdateStyleRequest request);
        partial void PrepareUpdateStyleRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::Krea.UpdateStyleRequest request);
        partial void ProcessUpdateStyleResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateStyleResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Krea.Style> UpdateStyleAsync(
            string id,
        ...
        {
            var __response = await UpdateStyleAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Krea.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Krea.AutoSDKHttpResponse<global::Krea.Style>> UpdateStyleAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Krea.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateStyleSecurityRequirements,
                operationName: "UpdateStyleAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Krea.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Krea.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateStyleAsync",
                                pathTemplate: "$\"/styles/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Krea.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateStyleResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Krea.Style.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Krea.AutoSDKHttpResponse<global::Krea.Style>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Krea.Style.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Krea.Style> UpdateStyleAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Krea.UpdateStyleRequest
            {
                Name = name,
                Description = description,
            };

            return await UpdateStyleAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
