...
namespace Krea
{
    public partial class VideoClient
    {
        ...
        private static readonly global::Krea.EndPointSecurityRequirement s_GenerateSeedance2FastSecurityRequirement0 =
        ...
        private static readonly global::Krea.EndPointSecurityRequirement[] s_GenerateSeedance2FastSecurityRequirements =
            new global::Krea.EndPointSecurityRequirement[]
            {                s_GenerateSeedance2FastSecurityRequirement0,
            };
        partial void PrepareGenerateSeedance2FastArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Krea.VideoGenerationRequest request);
        partial void PrepareGenerateSeedance2FastRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Krea.VideoGenerationRequest request);
        partial void ProcessGenerateSeedance2FastResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateSeedance2FastResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Generate video with Seedance 2.0 Fast
        /// </summary>
        /// <param name="request"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Krea.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Krea.Job> GenerateSeedance2FastAsync(

            global::Krea.VideoGenerationRequest request,
            global::Krea.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenerateSeedance2FastAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Krea.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Krea.AutoSDKHttpResponse<global::Krea.Job>> GenerateSeedance2FastAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateSeedance2FastArguments(
            ...
            var __authorizations = global::Krea.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateSeedance2FastSecurityRequirements,
                operationName: "GenerateSeedance2FastAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Krea.PathBuilder(
                                path: "/generate/video/bytedance/seedance-2-fast",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateSeedance2FastRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Krea.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Krea.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateSeedance2Fast",
                                methodName: "GenerateSeedance2FastAsync",
                                pathTemplate: "\"/generate/video/bytedance/seedance-2-fast\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateSeedance2FastResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Krea.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateSeedance2FastResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GenerateSeedance2FastAsync(
                request: __request,
                requestOptions: requestOptions,
