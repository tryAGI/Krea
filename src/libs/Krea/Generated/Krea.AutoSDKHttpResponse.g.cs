...
namespace Krea
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Krea.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Krea.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Krea.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Krea.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Krea.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Krea.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Krea.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Krea.ApiException exception)
        ...
        private static global::Krea.AutoSDKRequestOptions CloneRequestOptions(
            global::Krea.AutoSDKRequestOptions? source)
        {
            var clone = new global::Krea.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
