...
namespace Krea
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Krea.AutoSDKRetryOptions Retry { get; set; } = new global::Krea.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Krea.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Krea.IAutoSDKHook>();
        ...
        public global::Krea.AutoSDKClientOptions AddHook(
            global::Krea.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Krea.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Krea.AutoSDKClientOptions UseAuthorizationProvider(
            global::Krea.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Krea.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Krea.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Krea.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Krea.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Krea.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Krea.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Krea.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Krea.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Krea.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Krea.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Krea.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Krea.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Krea.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Krea.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Krea.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Krea.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Krea.AutoSDKClientOptions clientOptions,
            global::Krea.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Krea.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Krea.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Krea.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Krea.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Krea.IAutoSDKHook, global::Krea.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Krea.AutoSDKHookContext context)
        {
