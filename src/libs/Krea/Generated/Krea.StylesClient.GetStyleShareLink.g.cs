...
namespace Krea
{
    public partial class StylesClient
    {
        ...
        private static readonly global::Krea.EndPointSecurityRequirement s_GetStyleShareLinkSecurityRequirement0 =
        ...
        private static readonly global::Krea.EndPointSecurityRequirement[] s_GetStyleShareLinkSecurityRequirements =
            new global::Krea.EndPointSecurityRequirement[]
            {                s_GetStyleShareLinkSecurityRequirement0,
            };
        partial void PrepareGetStyleShareLinkArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareGetStyleShareLinkRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessGetStyleShareLinkResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetStyleShareLinkResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Krea.StyleShareLink> GetStyleShareLinkAsync(
            string id,
            global::Krea.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetStyleShareLinkAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Krea.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Krea.AutoSDKHttpResponse<global::Krea.StyleShareLink>> GetStyleShareLinkAsResponseAsync(
            string id,
            global::Krea.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetStyleShareLinkArguments(
            ...
            var __authorizations = global::Krea.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetStyleShareLinkSecurityRequirements,
                operationName: "GetStyleShareLinkAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetStyleShareLinkRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Krea.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Krea.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetStyleShareLink",
                                methodName: "GetStyleShareLinkAsync",
                                pathTemplate: "$\"/styles/{id}/share/link\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetStyleShareLinkResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Krea.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetStyleShareLinkResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Krea.StyleShareLink.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Krea.AutoSDKHttpResponse<global::Krea.StyleShareLink>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Krea.StyleShareLink.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
