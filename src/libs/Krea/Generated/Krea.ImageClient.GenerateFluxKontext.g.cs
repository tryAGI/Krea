...
namespace Krea
{
    public partial class ImageClient
    {
        ...
        private static readonly global::Krea.EndPointSecurityRequirement s_GenerateFluxKontextSecurityRequirement0 =
        ...
        private static readonly global::Krea.EndPointSecurityRequirement[] s_GenerateFluxKontextSecurityRequirements =
            new global::Krea.EndPointSecurityRequirement[]
            {                s_GenerateFluxKontextSecurityRequirement0,
            };
        partial void PrepareGenerateFluxKontextArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Krea.FluxKontextRequest request);
        partial void PrepareGenerateFluxKontextRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Krea.FluxKontextRequest request);
        partial void ProcessGenerateFluxKontextResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateFluxKontextResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Edit image with Flux Kontext<br/>
        /// Image-editing endpoint - takes a source `imageUrl` plus a text prompt describing the desired edit.
        /// </summary>
        /// <param name="request"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Krea.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Krea.Job> GenerateFluxKontextAsync(

            global::Krea.FluxKontextRequest request,
            global::Krea.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenerateFluxKontextAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Krea.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Krea.AutoSDKHttpResponse<global::Krea.Job>> GenerateFluxKontextAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateFluxKontextArguments(
            ...
            var __authorizations = global::Krea.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateFluxKontextSecurityRequirements,
                operationName: "GenerateFluxKontextAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateFluxKontextRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Krea.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Krea.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GenerateFluxKontextAsync",
                                pathTemplate: "\"/generate/image/bfl/flux-1-kontext-dev\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateFluxKontextResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Krea.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateFluxKontextResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Krea.Job> GenerateFluxKontextAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Krea.FluxKontextRequest
            {
                Prompt = prompt,
                ImageUrl = imageUrl,
                Strength = strength,
                ...
                Width = width,
                Height = height,
                GuidanceScaleFlux = guidanceScaleFlux,
                RelaxedModeAccess = relaxedModeAccess,
                StyleImages = styleImages,
                ImageStyleRefs = imageStyleRefs,
                Styles = styles,
            };

            return await GenerateFluxKontextAsync(
                request: __request,
                requestOptions: requestOptions,
